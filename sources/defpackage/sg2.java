...
public interface sg2 {
    ...
    <T> void mergeGroupField(T t, ln2 ln2Var, xu0 xu0Var) throws IOException;

    <T> void mergeMessageField(T t, ln2 ln2Var, xu0 xu0Var) throws IOException;

    boolean readBool() throws IOException;

    void readBoolList(List<Boolean> list) throws IOException;

    g readBytes() throws IOException;

    void readBytesList(List<g> list) throws IOException;
    ...
    @Deprecated
    <T> T readGroup(Class<T> cls, xu0 xu0Var) throws IOException;

    @Deprecated
    <T> T readGroupBySchemaWithCheck(ln2 ln2Var, xu0 xu0Var) throws IOException;

    @Deprecated
    <T> void readGroupList(List<T> list, Class<T> cls, xu0 xu0Var) throws IOException;

    @Deprecated
    <T> void readGroupList(List<T> list, ln2 ln2Var, xu0 xu0Var) throws IOException;
    ...
    <K, V> void readMap(Map<K, V> map, qp1 qp1Var, xu0 xu0Var) throws IOException;

    <T> T readMessage(Class<T> cls, xu0 xu0Var) throws IOException;

    <T> T readMessageBySchemaWithCheck(ln2 ln2Var, xu0 xu0Var) throws IOException;

    <T> void readMessageList(List<T> list, Class<T> cls, xu0 xu0Var) throws IOException;

    <T> void readMessageList(List<T> list, ln2 ln2Var, xu0 xu0Var) throws IOException;
