...
public final class mg0 implements xm, hb3 {
    public static final ji2 n = hb1.p(4400000L, 3200000L, 2300000L, 1600000L, 810000L);
    public static final ji2 o = hb1.p(1400000L, 990000L, 730000L, 510000L, 230000L);
    public static final ji2 p = hb1.p(2100000L, 1400000L, 1000000L, 890000L, 640000L);
    public static final ji2 q = hb1.p(2600000L, 1700000L, 1300000L, 1000000L, 700000L);
    public static final ji2 r = hb1.p(5700000L, 3700000L, 2300000L, 1700000L, 990000L);
    public static final ji2 s = hb1.p(2800000L, 1800000L, 1400000L, 1100000L, 870000L);
    public static mg0 t;

    /* renamed from: a, reason: collision with root package name */
    public final kb1 f3288a;

    /* renamed from: b, reason: collision with root package name */
    public final v51 f3289b = new v51(27);
    public final gw2 c;
    public final f10 d;
    ...
    public mg0(Context context, HashMap hashMap, int i, t43 t43Var, boolean z) {
        this.f3288a = kb1.c(hashMap);
        this.c = new gw2(i);
        this.d = t43Var;
        this.e = z;
        if (context != null) {
            wz1 b2 = wz1.b(context);
            int c = b2.c();
            this.i = c;
            this.l = b(c);
            kg0 kg0Var = new kg0(this);
            CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) b2.c;
            ...
            copyOnWriteArrayList.add(new WeakReference(kg0Var));
            ((Handler) b2.f5091b).post(new lf(17, b2, kg0Var));
            return;
        }
        this.i = 0;
        this.l = b(0);
    ...
    public final long b(int i) {
        ...
        kb1 kb1Var = this.f3288a;
        Long l = (Long) kb1Var.get(valueOf);
        if (l == null) {
            l = (Long) kb1Var.get(0);
        }
        if (l == null) {
    ...
    public final void c(int i, long j, long j2) {
        ...
        this.m = j2;
        Iterator it = ((CopyOnWriteArrayList) this.f3289b.f4780b).iterator();
        while (it.hasNext()) {
            wm wmVar = (wm) it.next();
            if (!wmVar.c) {
                wmVar.f5035a.post(new ei(wmVar, i, j, j2, 1));
            }
        }
    }
}
