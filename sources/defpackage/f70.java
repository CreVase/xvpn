...
public class f70 extends ViewGroup.MarginLayoutParams {
    public int A;
    public int B;
    public final int C;
    public final int D;
    ...
    public f70(Context context, AttributeSet attributeSet) {
        ...
        this.l0 = 0.5f;
        this.p0 = new r70();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, vf2.ConstraintLayout_Layout);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            int i2 = e70.f1892a.get(index);
            switch (i2) {
                case 1:
                ...
                case 5:
                    this.f2052a = obtainStyledAttributes.getDimensionPixelOffset(index, this.f2052a);
                    break;
                case 6:
                    this.f2053b = obtainStyledAttributes.getDimensionPixelOffset(index, this.f2053b);
                    break;
                case 7:
                ...
                default:
                    switch (i2) {
                        case 44:
                            p70.h(this, obtainStyledAttributes.getString(index));
                            break;
                        case 45:
    ...
    public final void a() {
        ...
        if (this.c != -1.0f || this.f2052a != -1 || this.f2053b != -1) {
            this.d0 = true;
            this.a0 = true;
            this.b0 = true;
            if (!(this.p0 instanceof t61)) {
                this.p0 = new t61();
            }
            ((t61) this.p0).S(this.V);
        }
    }
    ...
    */
    public final void resolveLayoutDirection(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f70.resolveLayoutDirection(int):void");
    }
    ...
    public f70(ViewGroup.LayoutParams layoutParams) {
        super(layoutParams);
        this.f2052a = -1;
        this.f2053b = -1;
        this.c = -1.0f;
