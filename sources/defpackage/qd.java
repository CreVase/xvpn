...
public class qd extends ImageButton {
    ...
    public final void drawableStateChanged() {
        ...
        kc kcVar = this.f3983a;
        if (kcVar != null) {
            kcVar.a();
        }
        rd rdVar = this.f3984b;
        if (rdVar != null) {
            rdVar.a();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(((ImageView) this.f3984b.f4133b).getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
