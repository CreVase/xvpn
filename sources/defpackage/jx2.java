...
public final class jx2 {
    ...
    public jx2(int i, int i2, float f, float f2, int i3) {
        this.f2849a = i;
        this.f2850b = i2;
        this.c = f;
        this.d = f2;
            ...
            if (i17 >= i18) {
                ...
                while (true) {
                    ...
                    if (i20 > 0) {
                        ...
                        int i27 = this.u;
                        int i28 = this.v;
                        if (i27 != 0 && this.s != 0 && i28 <= i27 * 3 && i27 * 2 > this.t * 3) {
                            z = true;
                        } else {
                            z = false;
                        }
                        ...
                        if (d > 1.0d) {
                            ...
                            this.l = c;
                            int i29 = i19;
                            e(i7, this.f2850b, c, this.m, sArr3, i29, sArr3, i19 + i5);
                            this.m += i7;
                            i19 = i5 + i7 + i29;
                        } else {
                            int i30 = i19;
                            ...
                            this.l = c2;
                            System.arraycopy(sArr4, i30 * i15, c2, this.m * i15, i15 * i5);
                            e(i6, this.f2850b, this.l, this.m + i5, sArr4, i30 + i5, sArr4, i30);
                            this.m += i31;
                            i19 = i30 + i6;
                        }
                    }
                ...
                int i32 = this.k - i19;
                short[] sArr5 = this.j;
                System.arraycopy(sArr5, i19 * i15, sArr5, 0, i15 * i32);
                this.k = i32;
                if (f == 1.0f && this.m != (i8 = i3)) {
                    ...
                    int i36 = this.m - i8;
                    short[] c3 = c(this.n, this.o, i36);
                    this.n = c3;
                    System.arraycopy(this.l, i8 * i15, c3, this.o * i15, i15 * i36);
                    this.m = i8;
                    this.o += i36;
                    int i37 = 0;
                    while (true) {
