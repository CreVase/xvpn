...
public final class RtbTokens$CCPA$$serializer implements n51 {
    ...
    static {
        ...
        f62 f62Var = new f62("com.vungle.ads.internal.model.RtbTokens.CCPA", rtbTokens$CCPA$$serializer, 1);
    ...
    public RtbTokens.CCPA deserialize(qe0 qe0Var) {
        ...
        c.a(descriptor2);
        return new RtbTokens.CCPA(i, str, null);
    }
    ...
    public void serialize(ir0 ir0Var, RtbTokens.CCPA ccpa) {
        mp2 descriptor2 = getDescriptor();
