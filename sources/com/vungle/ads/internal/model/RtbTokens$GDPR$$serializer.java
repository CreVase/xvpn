...
public final class RtbTokens$GDPR$$serializer implements n51 {
    ...
    static {
        ...
        f62 f62Var = new f62("com.vungle.ads.internal.model.RtbTokens.GDPR", rtbTokens$GDPR$$serializer, 4);
        f62Var.j("status", false);
        f62Var.j("source", false);
        f62Var.j("message_version", false);
        f62Var.j("timestamp", false);
        descriptor = f62Var;
    }
    ...
    public uh1[] childSerializers() {
        ...
        return new uh1[]{b23Var, b23Var, b23Var, jo1.f2800a};
    }

    @Override // defpackage.sk0
    public RtbTokens.GDPR deserialize(qe0 qe0Var) {
    ...
    public void serialize(ir0 ir0Var, RtbTokens.GDPR gdpr) {
        mp2 descriptor2 = getDescriptor();
