...
public final class AdPayload$PlacementAdUnit$$serializer implements n51 {
    ...
    static {
        ...
        f62 f62Var = new f62("com.vungle.ads.internal.model.AdPayload.PlacementAdUnit", adPayload$PlacementAdUnit$$serializer, 2);
        f62Var.j("placement_reference_id", true);
        f62Var.j("ad_markup", true);
        descriptor = f62Var;
    }
    ...
    public uh1[] childSerializers() {
        return new uh1[]{t9.K(b23.f390a), t9.K(AdPayload$AdUnit$$serializer.INSTANCE)};
    }

    @Override // defpackage.sk0
    public AdPayload.PlacementAdUnit deserialize(qe0 qe0Var) {
        ...
        while (z) {
            ...
            if (j == -1) {
                ...
                obj = c.B(descriptor2, 1, AdPayload$AdUnit$$serializer.INSTANCE, obj);
                i |= 2;
            }
        }
        c.a(descriptor2);
        return new AdPayload.PlacementAdUnit(i, (String) obj2, (AdPayload.AdUnit) obj, (vp2) null);
    }
    ...
    public void serialize(ir0 ir0Var, AdPayload.PlacementAdUnit placementAdUnit) {
        mp2 descriptor2 = getDescriptor();
