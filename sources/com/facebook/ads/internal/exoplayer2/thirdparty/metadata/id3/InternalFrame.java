...
public final class InternalFrame extends Id3Frame {
    ...
    public InternalFrame(Parcel parcel) {
        super(A00(14, 4, 82));
        this.A01 = (String) HI.A01(parcel.readString());
        this.A00 = (String) HI.A01(parcel.readString());
        this.A02 = (String) HI.A01(parcel.readString());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        boolean A0g = C0436Hx.A0g(this.A00, internalFrame.A00);
        if (A04[4].length() != 19) {
            throw new RuntimeException();
        }
        A04[4] = "WYnJcvlfdgkhEaINowX";
        if (A0g && C0436Hx.A0g(this.A01, internalFrame.A01) && C0436Hx.A0g(this.A02, internalFrame.A02)) {
            return true;
        }
        return false;
    }
