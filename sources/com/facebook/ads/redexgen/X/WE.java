...
public final class WE implements InterfaceC0299Cg {
    ...
    */
    private void A00(com.facebook.ads.redexgen.X.C0420Hh r9) {
        /*
            r8 = this;
            byte[] r6 = r9.A00
            int r5 = r9.A06()
        ...
        L22:
            ...
            r9.A0Y(r0)
            r8.A08 = r4
            com.facebook.ads.redexgen.X.Hh r0 = r8.A0A
            byte[] r1 = r0.A00
            r0 = r6[r5]
            r1[r3] = r0
            r0 = 2
        ...
        L42:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.WE.A00(com.facebook.ads.redexgen.X.Hh):void");
    }

    private void A01(C0420Hh c0420Hh) {
        int min = Math.min(c0420Hh.A04(), this.A01 - this.A00);
        this.A05.AEr(c0420Hh, min);
        ...
        InterfaceC0288Bm interfaceC0288Bm = this.A05;
        if (A0C[2].charAt(7) == 'H') {
        ...
        interfaceC0288Bm.AEs(this.A04, 1, i, 0, null);
        this.A04 += this.A03;
        this.A00 = 0;
        this.A02 = 0;
    }

    private void A02(C0420Hh c0420Hh) {
        int min = Math.min(c0420Hh.A04(), 4 - this.A00);
        c0420Hh.A0c(this.A0A.A00, this.A00, min);
        int i = this.A00 + min;
        this.A00 = i;
        if (i < 4) {
            return;
        ...
        if (Bg.A04(this.A0A.A08(), this.A09)) {
            ...
            if (!this.A07) {
                ...
                this.A05.A5j(Format.A07(this.A06, this.A09.A06, null, -1, v.DEFAULT_BUFFER_SIZE, this.A09.A01, this.A09.A03, null, null, 0, this.A0B));
                this.A07 = true;
            }
            this.A0A.A0Y(0);
    ...
    public final void A4l(InterfaceC0280Bc interfaceC0280Bc, C0310Cu c0310Cu) {
        ...
        this.A05 = interfaceC0280Bc.AFx(c0310Cu.A03(), 1);
    }
