...
public final class HS implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new HQ(C0436Hx.A0P(A04(0, 67, 61), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static void A06(int[] iArr) {
        ...
        if (glGetError == 0) {
            ...
            throw new HQ(A04(181, 29, 20) + Integer.toHexString(glGetError));
        }
    }
