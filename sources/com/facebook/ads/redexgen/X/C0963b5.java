...
public final class C0963b5 implements C0K {
    ...
    static {
        A04();
        A07 = C0963b5.class.getSimpleName();
    }

    public C0963b5(String str) {
        this(str, C0I.A01(str));
    }

    public C0963b5(String str, int i) {
        this(str);
        this.A00 = i;
    }

    public C0963b5(String str, String str2) {
    ...
    private HttpURLConnection A02(int i, int i2) throws IOException, C0965b7 {
        ...
        do {
            ...
            if (i3 > 5) {
                ...
                throw new C0965b7(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws C0965b7 {
        String[] strArr;
        ...
        try {
            try {
                httpURLConnection = A02(0, VungleError.DEFAULT);
    ...
    private final void A05(int i, int i2) throws C0965b7 {
        try {
            HttpURLConnection A02 = A02(i, i2);
            this.A02 = A02;
            ...
            throw new C0965b7(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e);
        }
    }
    ...
    public final void close() throws C0965b7 {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C0965b7(A01(92, 37, 93), e);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final synchronized int length() throws C0965b7 {
    ...
    public final int read(byte[] bArr) throws C0965b7 {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new FT(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e);
            } catch (IOException e2) {
                throw new C0965b7(A01 + this.A03, e2);
            }
        }
        throw new C0965b7(A01 + this.A03 + A01(51, 23, 21));
    }

    public final String toString() {
        return A01(Sdk.SDKError.Reason.PLACEMENT_AD_TYPE_MISMATCH_VALUE, 19, 41) + this.A03 + A01(328, 1, 87);
    }
}
