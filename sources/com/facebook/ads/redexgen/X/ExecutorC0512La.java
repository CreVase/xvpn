...
public final class ExecutorC0512La implements Executor {
    ...
    static {
        A04();
        A08 = new ExecutorC0512La(A00(7, 7, 8), 0);
        A06 = new ExecutorC0512La(A00(0, 5, 91), 0);
        A07 = new ExecutorC0512La(A00(5, 2, 3), 0);
        A03 = 32;
    ...
    public ExecutorC0512La(String str, int i) {
        this.A02 = i;
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (ExecutorC0512La.class) {
            int i = A03;
            if (reservedExecutorQueueSize == i) {
                ...
                Y9 A00 = C7R.A00();
                if (A00 != null) {
                    A00.A07().A9M(A00(42, 7, 27), C01997x.A1c, new C02007y(A00(21, 21, 46), A00(14, 7, 25) + i));
                }
            }
        }
