...
public enum EnumC0606Oq {
    ...
    EnumC0606Oq(String str) {
        this.A00 = str;
    }

    public static EnumC0606Oq A00(String str) {
        for (EnumC0606Oq enumC0606Oq : values()) {
            if (enumC0606Oq.A00.equalsIgnoreCase(str)) {
                return enumC0606Oq;
            }
        }
        return A0O;
