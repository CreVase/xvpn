...
public final class AV extends Exception {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0049, code lost:            throw new java.lang.RuntimeException();     */
    /*
    ...
    */
    public static java.lang.String A00(int r4, int r5, int r6) {
        /*
            byte[] r1 = com.facebook.ads.redexgen.X.AV.A01
            int r0 = r4 + r5
            byte[] r3 = java.util.Arrays.copyOfRange(r1, r4, r0)
            r4 = 0
        L9:
            int r5 = r3.length
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.AV.A02
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 2
            if (r1 == r0) goto L44
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.AV.A02
        ...
        L44:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AV.A00(int, int, int):java.lang.String");
    }
