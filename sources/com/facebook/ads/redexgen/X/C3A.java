...
public final class C3A extends BI {
    ...
    public final ArrayList<C0365Fc> A0B = new ArrayList<>();
    public C0365Fc A04 = new C0365Fc(0, 4);
    ...
    static {
        ...
        A0I = new int[]{193, 201, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, 194, 199, 200, 202, 203, 235, 206, Sdk.SDKError.Reason.PLACEMENT_AD_TYPE_MISMATCH_VALUE, 239, 212, 217, 249, 219, 171, 187};
    ...
    private void A0A(byte b2, byte b3) {
        ...
        if (i != row3) {
            ...
            if (row4 != 1 && !this.A04.A0F()) {
                int i2 = this.A02;
                int row5 = this.A03;
                C0365Fc c0365Fc = new C0365Fc(i2, row5);
                this.A04 = c0365Fc;
                this.A0B.add(c0365Fc);
            }
            this.A04.A0C(i);
        }
        ...
        int row7 = b3 >> 1;
        int i3 = row7 & 7;
        C0365Fc c0365Fc2 = this.A04;
        int row8 = cursorOrStyle != 0 ? 8 : i3;
        c0365Fc2.A0E(row8, isCursor);
        if (cursorOrStyle != 0) {
            C0365Fc c0365Fc3 = this.A04;
            int row9 = A0F[i3];
            c0365Fc3.A0B(row9);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x007b, code lost:            if (r3 != false) goto L31;     */
    /* JADX WARN: Code restructure failed: missing block: B:31:0x007d, code lost:            A09(r7);     */
    /* JADX WARN: Code restructure failed: missing block: B:33:0x008d, code lost:            if (r3 != false) goto L31;     */
    /*
    ...
    */
    private boolean A0E(byte r6, byte r7) {
        /*
            ...
            r0 = 0
            r5.A07 = r0
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C3A.A0D
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            if (r1 == r0) goto L30
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C3A.A0D
        ...
        L50:
            ...
            if (r0 == 0) goto L5e
            com.facebook.ads.redexgen.X.Fc r1 = r5.A04
            int r0 = r7 + (-32)
            r1.A0D(r0)
            goto L45
        L5e:
        ...
        L81:
            ...
            goto L7d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C3A.A0E(byte, byte):boolean");
    }
    ...
    @Override // com.facebook.ads.redexgen.X.BI, com.facebook.ads.redexgen.X.InterfaceC0271At
    public final void AEO() {
    }

    @Override // com.facebook.ads.redexgen.X.BI, com.facebook.ads.redexgen.X.InterfaceC0773Vc
