...
public final class AnonymousClass86 {
    ...
    public static void A0A(C7S c7s) {
        try {
            boolean z = true;
            c7s = C0489Kb.A00(c7s, null, new IntentFilter(A01(24, 37, 122)), true);
            if (c7s == 0) {
                return;
            }
            int intExtra = c7s.getIntExtra(A01(109, 5, 89), -1);
            int status = c7s.getIntExtra(A01(123, 5, 3), -1);
            int intExtra2 = c7s.getIntExtra(A01(134, 6, 71), -1);
            ...
            c7s.A07().A9M(A01(102, 7, 57), C01997x.A1T, new C02007y(e));
        }
    }
