...
public final class C8M {
    ...
    public static long A01(C7S c7s) {
        try {
            PackageManager packageManager = c7s.getPackageManager();
            if (packageManager == null) {
                return -1L;
            }
            return new File(packageManager.getApplicationInfo(c7s.getPackageName(), 0).publicSourceDir).length();
        } catch (Exception e) {
            if (A03.compareAndSet(false, true)) {
                c7s.A07().A9M(A02(144, 7, 117), C01997x.A1E, new C02007y(e));
            }
            return -1L;
        }
    }
    ...
    public static String A05(C7S c7s) {
        ...
        A07(c7s, jSONObject, A02(174, 6, 127), String.valueOf(A08()));
        A07(c7s, jSONObject, A02(97, 8, 52), String.valueOf(A01(c7s)));
        A07(c7s, jSONObject, A02(SubsamplingScaleImageView.ORIENTATION_180, 15, 73), String.valueOf(A00()));
        A07(c7s, jSONObject, A02(105, 18, 113), String.valueOf(KI.A01(c7s)));
        A07(c7s, jSONObject, A02(161, 13, 111), String.valueOf(A09(c7s)));
        A07(c7s, jSONObject, A02(133, 11, 61), A04(c7s));
        A07(c7s, jSONObject, A02(123, 10, 96), A03(c7s));
        return jSONObject.toString();
    }

    public static void A07(C7S c7s, JSONObject jSONObject, String str, String str2) {
        try {
