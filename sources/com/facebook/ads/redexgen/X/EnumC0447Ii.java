...
public enum EnumC0447Ii {
    ...
    EnumC0447Ii(String str) {
        this.A00 = str;
    }

    public static EnumC0447Ii A00(String str) {
        for (EnumC0447Ii enumC0447Ii : values()) {
            if (enumC0447Ii.A00.equalsIgnoreCase(str)) {
                return enumC0447Ii;
            }
        }
        String[] strArr = A02;
