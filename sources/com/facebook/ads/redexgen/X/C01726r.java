...
public final class C01726r extends PX {
    ...
    public final AbstractC0591Ob A01;
    public final MU A02;
    public final MI A03;
    ...
    public C01726r(YA ya) {
        super(ya);
        this.A00 = null;
        this.A01 = new AbstractC0591Ob() { // from class: com.facebook.ads.redexgen.X.6v
            ...
            public final void A03(AnonymousClass75 anonymousClass75) {
                ...
                AudioManager audioManager = (AudioManager) C01726r.this.getContext().getApplicationContext().getSystemService(A00(0, 5, 67));
                weakReference = C01726r.this.A00;
                if (weakReference == null) {
                    onAudioFocusChangeListener = null;
                } else {
                    weakReference2 = C01726r.this.A00;
        ...
        this.A02 = new MU() { // from class: com.facebook.ads.redexgen.X.6u
            ...
            public final void A03(AnonymousClass72 anonymousClass72) {
                ...
                WeakReference weakReference2;
                AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener;
                AudioManager audioManager = (AudioManager) C01726r.this.getContext().getApplicationContext().getSystemService(A00(0, 5, 113));
                weakReference = C01726r.this.A00;
                if (weakReference == null) {
                    onAudioFocusChangeListener = null;
                } else {
