...
public final class C02088g implements Closeable {
    ...
    public C02088g(File file) throws IOException {
        ...
        this.A00 = new C02098h(readInt, fileIdx);
    }
    ...
    public final C02098h A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C02098h c02098h) throws IOException {
        if (!this.A01) {
            if (c02098h.A02() >= 0 && c02098h.A03() >= 0) {
                this.A00 = c02098h;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c02098h.A02()), Integer.valueOf(c02098h.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
