...
public final class C0789Vu implements DE {
     ...
     */
    public static ChapterFrame A06(C0420Hh c0420Hh, int i, int i2, boolean z, int i3, DQ dq) throws UnsupportedEncodingException {
        int A06 = c0420Hh.A06();
        int A022 = A02(c0420Hh.A00, A06);
        String str = new String(c0420Hh.A00, A06, A022 - A06, A0I(169, 10, 32));
        c0420Hh.A0Y(A022 + 1);
        int A08 = c0420Hh.A08();
        ...
        int i4 = A06 + i;
        while (c0420Hh.A06() < i4) {
            Id3Frame A0B = A0B(i2, c0420Hh, z, i3, dq);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 11 out of bounds for length 11
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static GeobFrame A09(C0420Hh c0420Hh, int i) throws UnsupportedEncodingException {
        int A0E = c0420Hh.A0E();
        String A0H = A0H(A0E);
        byte[] bArr = new byte[i - 1];
        c0420Hh.A0c(bArr, 0, i - 1);
        int A022 = A02(bArr, 0);
    ...
    public static int A01(C0420Hh c0420Hh, int i) {
        byte[] bArr = c0420Hh.A00;
        for (int A06 = c0420Hh.A06(); A06 + 1 < i; A06++) {
            int i2 = bArr[A06];
    ...
    */
    public static int A02(byte[] r1, int r2) {
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0789Vu.A02(byte[], int):int");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L21:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0789Vu.A03(byte[], int, int):int");
    }

    public static ApicFrame A04(C0420Hh c0420Hh, int i, int i2) throws UnsupportedEncodingException {
        int A022;
        String A0M;
        int descriptionStartIndex = c0420Hh.A0E();
        String A0H = A0H(descriptionStartIndex);
        int encoding = i - 1;
        byte[] bArr = new byte[encoding];
        int encoding2 = i - 1;
        c0420Hh.A0c(bArr, 0, encoding2);
        String A0I = A0I(458, 6, 45);
        String A0I2 = A0I(169, 10, 32);
        if (i2 == 2) {
            A022 = 2;
            A0M = A0I + C0436Hx.A0M(new String(bArr, 0, 3, A0I2));
            if (A0I(474, 9, 58).equals(A0M)) {
                A0M = A0I(464, 10, 126);
            }
        } else {
            A022 = A02(bArr, 0);
            A0M = C0436Hx.A0M(new String(bArr, 0, A022, A0I2));
            if (A0M.indexOf(47) == -1) {
                A0M = A0I + A0M;
            }
        }
    ...
    public static BinaryFrame A05(C0420Hh c0420Hh, int i, String str) {
        byte[] bArr = new byte[i];
        c0420Hh.A0c(bArr, 0, i);
        return new BinaryFrame(str, bArr);
    }

    public static ChapterTocFrame A07(C0420Hh c0420Hh, int i, int i2, boolean z, int framePosition, DQ dq) throws UnsupportedEncodingException {
        int A06 = c0420Hh.A06();
        int A022 = A02(c0420Hh.A00, A06);
        String A0I = A0I(169, 10, 32);
        String str = new String(c0420Hh.A00, A06, A022 - A06, A0I);
        c0420Hh.A0Y(A022 + 1);
        int framePosition2 = c0420Hh.A0E();
        boolean z2 = (framePosition2 & 2) != 0;
        boolean z3 = (framePosition2 & 1) != 0;
        int A0E = c0420Hh.A0E();
        String[] strArr = new String[A0E];
        for (int i3 = 0; i3 < A0E; i3++) {
            int startIndex = c0420Hh.A06();
            int i4 = A02(c0420Hh.A00, startIndex);
            int framePosition3 = i4 - startIndex;
            strArr[i3] = new String(c0420Hh.A00, startIndex, framePosition3, A0I);
            c0420Hh.A0Y(i4 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i5 = A06 + i;
        while (c0420Hh.A06() < i5) {
            String[] strArr2 = A02;
            ...
            Id3Frame A0B = A0B(i2, c0420Hh, z, framePosition, dq);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    public static CommentFrame A08(C0420Hh c0420Hh, int i) throws UnsupportedEncodingException {
        if (i < 4) {
            return null;
        }
        int textStartIndex = c0420Hh.A0E();
        String A0H = A0H(textStartIndex);
        byte[] bArr = new byte[3];
        c0420Hh.A0c(bArr, 0, 3);
        String description = new String(bArr, 0, 3);
        int encoding = i - 4;
        byte[] data = new byte[encoding];
        int encoding2 = i - 4;
        c0420Hh.A0c(data, 0, encoding2);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x008b, code lost:            if (r0 != 0) goto L29;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.redexgen.X.DR A0A(com.facebook.ads.redexgen.X.C0420Hh r9) {
        /*
            int r4 = r9.A04()
            r3 = 10
            r8 = 0
        ...
        L21:
            int r4 = r9.A0G()
            int r0 = com.facebook.ads.redexgen.X.C0789Vu.A03
            if (r4 == r0) goto L48
        ...
        L87:
            ...
            if (r0 == 0) goto L93
        L8d:
            com.facebook.ads.redexgen.X.DR r0 = new com.facebook.ads.redexgen.X.DR
            r0.<init>(r4, r3, r2)
            return r0
        L93:
            r3 = 0
        ...
        Lb8:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0789Vu.A0A(com.facebook.ads.redexgen.X.Hh):com.facebook.ads.redexgen.X.DR");
    }

    /* JADX WARN: Code restructure failed: missing block: B:88:0x01b7, code lost:            if (r7 == 86) goto L119;     */
    /* JADX WARN: Code restructure failed: missing block: B:89:0x01bc, code lost:            r13 = A0C(r26, r6);     */
    /* JADX WARN: Code restructure failed: missing block: B:90:0x01ba, code lost:            if (r7 == 86) goto L119;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.Id3Frame A0B(int r25, com.facebook.ads.redexgen.X.C0420Hh r26, boolean r27, int r28, com.facebook.ads.redexgen.X.DQ r29) {
        /*
            Method dump skipped, instructions count: 741
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0789Vu.A0B(int, com.facebook.ads.redexgen.X.Hh, boolean, int, com.facebook.ads.redexgen.X.DQ):com.facebook.ads.internal.exoplayer2.thirdparty.metadata.id3.Id3Frame");
    }

    public static PrivFrame A0C(C0420Hh c0420Hh, int i) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i];
        c0420Hh.A0c(bArr, 0, i);
        int A022 = A02(bArr, 0);
    ...
    public static TextInformationFrame A0D(C0420Hh c0420Hh, int i) throws UnsupportedEncodingException {
        if (i < 1) {
            return null;
        }
        int valueStartIndex = c0420Hh.A0E();
    ...
    public static TextInformationFrame A0E(C0420Hh c0420Hh, int i, String str) throws UnsupportedEncodingException {
        if (i < 1) {
            return null;
        }
        int A0E = c0420Hh.A0E();
    ...
    public static UrlLinkFrame A0F(C0420Hh c0420Hh, int i) throws UnsupportedEncodingException {
        if (i < 1) {
            return null;
        }
        int descriptionEndIndex = c0420Hh.A0E();
    ...
    public static UrlLinkFrame A0G(C0420Hh c0420Hh, int i, String str) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i];
        c0420Hh.A0c(bArr, 0, i);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00af, code lost:            if (r8 != false) goto L39;     */
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b1, code lost:            r7 = 0 + 1;     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00b3, code lost:            if (r9 == 0) goto L42;     */
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00b5, code lost:            r7 = r7 + 4;     */
    /* JADX WARN: Code restructure failed: missing block: B:46:0x00ba, code lost:            if (r3 >= r7) goto L60;     */
    /* JADX WARN: Code restructure failed: missing block: B:47:0x00e7, code lost:            r0 = r16.A04();     */
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00ee, code lost:            if (r0 >= r3) goto L63;     */
    /* JADX WARN: Code restructure failed: missing block: B:52:0x00f7, code lost:            r16.A0Y(r5);     */
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00fa, code lost:            return false;     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x00bc, code lost:            r16.A0Y(r5);     */
    /* JADX WARN: Code restructure failed: missing block: B:56:0x00bf, code lost:            return false;     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x00cc, code lost:            if (r8 != false) goto L39;     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0M(com.facebook.ads.redexgen.X.C0420Hh r16, int r17, int r18, boolean r19) {
        /*
            Method dump skipped, instructions count: 262
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0789Vu.A0M(com.facebook.ads.redexgen.X.Hh, int, int, boolean):boolean");
    }
    ...
    public final Metadata A0O(byte[] bArr, int i) {
        ...
        int i8;
        ArrayList arrayList = new ArrayList();
        C0420Hh c0420Hh = new C0420Hh(bArr, i);
        DR A0A = A0A(c0420Hh);
        if (A0A == null) {
            return null;
        }
        int startPosition = c0420Hh.A06();
        i2 = A0A.A01;
        ...
        c0420Hh.A0X(startPosition + i3);
        boolean z2 = false;
        i4 = A0A.A01;
        if (!A0M(c0420Hh, i4, frameHeaderSize, false)) {
            i6 = A0A.A01;
            if (i6 == 4 && A0M(c0420Hh, 4, frameHeaderSize, true)) {
                z2 = true;
            } else {
                StringBuilder append = new StringBuilder().append(A0I(84, 45, 51));
                i7 = A0A.A01;
                Log.w(A0I(179, 10, 19), append.append(i7).toString());
                return null;
            }
        }
        while (c0420Hh.A04() >= frameHeaderSize) {
            i5 = A0A.A01;
            Id3Frame A0B = A0B(i5, c0420Hh, z2, frameHeaderSize, this.A00);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
