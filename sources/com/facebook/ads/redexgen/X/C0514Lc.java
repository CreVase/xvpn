...
public final class C0514Lc {
    public static Bitmap A00(YA ya, Bitmap bitmap, int i) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(ya);
    ...
    public static Bitmap A01(YA ya, Bitmap bitmap, int i, int i2) {
        ...
        try {
            Bitmap A00 = A00(ya, createBitmap, i);
            if (i2 != 1) {
            ...
            return new C0736Tr().A02(createBitmap, i);
        }
    }
}
