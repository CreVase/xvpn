...
public final class HM {
    ...
    public static int A00(C0419Hg c0419Hg) {
        int A042 = c0419Hg.A04(5);
        if (A042 == 31) {
            int audioObjectType = c0419Hg.A04(6);
            return audioObjectType + 32;
        }
        return A042;
    }

    public static int A01(C0419Hg c0419Hg) {
        int A042 = c0419Hg.A04(4);
        if (A042 == 15) {
            int frequencyIndex = c0419Hg.A04(24);
    ...
    public static Pair<Integer, Integer> A02(C0419Hg c0419Hg, boolean z) throws C02309d {
        int A002 = A00(c0419Hg);
        int A012 = A01(c0419Hg);
        int channelConfiguration = c0419Hg.A04(4);
        if (A002 == 5 || A002 == 29) {
            A012 = A01(c0419Hg);
            String[] strArr = A01;
            String str = strArr[0];
            ...
            A002 = A00(c0419Hg);
            if (A002 == 22) {
                channelConfiguration = c0419Hg.A04(4);
            }
        }
        if (z) {
            switch (A002) {
                ...
                case 22:
                case 23:
                    A06(c0419Hg, A002, channelConfiguration);
                    switch (A002) {
                        case 17:
                        case 19:
                        case 20:
                        ...
                        case 22:
                        case 23:
                            int epConfig = c0419Hg.A04(2);
                            if (epConfig == 2 || epConfig == 3) {
                                throw new C02309d(A04(31, 22, 104) + epConfig);
                            }
                            break;
                    }
                case 5:
                ...
                case 18:
                default:
                    throw new C02309d(A04(0, 31, 107) + A002);
            }
        }
    ...
    public static Pair<Integer, Integer> A03(byte[] bArr) throws C02309d {
        return A02(new C0419Hg(bArr), false);
    }

    public static void A06(C0419Hg c0419Hg, int i, int i2) {
        c0419Hg.A08(1);
        if (c0419Hg.A0F()) {
            c0419Hg.A08(14);
        }
