...
public final class C02098h {
    ...
    public final int A04(C02098h c02098h) {
        int i = this.A00;
        int i2 = c02098h.A00;
        if (i != i2) {
            return i - i2;
        }
        return this.A01 - c02098h.A01;
    }

    public final C02098h A05(int i) {
        int i2 = this.A01;
        if (i + i2 >= 0) {
            return new C02098h(this.A00, i2 + i);
        }
        throw new IllegalArgumentException(String.format(Locale.US, A00(0, 35, 63), Integer.valueOf(i), Integer.valueOf(this.A01)));
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof C02098h)) {
            return false;
        }
        C02098h c02098h = (C02098h) obj;
        int i = c02098h.A00;
        int i2 = this.A00;
        if (A03[4].charAt(2) != 'U') {
        ...
        return i == i2 && c02098h.A01 == this.A01;
    }
