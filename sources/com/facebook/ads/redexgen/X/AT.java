...
public final class AT extends Exception {
    ...
    */
    public AT(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AT.<init>(int, int, int, int):void");
    }
}
