...
public final class C0553Mp extends ViewGroup {
    public static final int A01 = (int) (C0506Ku.A02 * 8.0f);
    public int A00;

    public C0553Mp(YA ya) {
        super(ya);
    ...
    */
    public final void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
        ...
        L27:
            ...
            int r0 = com.facebook.ads.redexgen.X.C0553Mp.A01
            int r0 = r0 + r3
            int r7 = r7 + r0
            int r5 = r5 + 1
            goto La
        L35:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0553Mp.onLayout(boolean, int, int, int, int):void");
    }
    ...
    */
    public final void onMeasure(int r11, int r12) {
        ...
        L2f:
            ...
            int r1 = com.facebook.ads.redexgen.X.C0553Mp.A01
            int r0 = r0 + r1
        ...
        L60:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0553Mp.onMeasure(int, int):void");
    }
}
