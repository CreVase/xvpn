...
public final class C0768Ux implements HC {
    ...
    public static final C0768Ux A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C0768Ux(Collections.emptyMap());
    }

    public C0768Ux(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static C0768Ux A00(DataInputStream dataInputStream) throws IOException {
    ...
    */
    public static void A04(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0768Ux.A04(java.util.HashMap, java.util.List):void");
    }
    ...
    public final C0768Ux A08(HE he) {
        Map<String, byte[]> A022 = A02(this.A01, he);
        if (A06(A022)) {
            return this;
        }
        return new C0768Ux(A022);
    }
