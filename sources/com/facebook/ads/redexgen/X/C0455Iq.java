...
public final class C0455Iq {
     ...
     */
    public static void A06(C7S c7s, InterfaceC0649Qh interfaceC0649Qh, Map<String, ?> map) throws JSONException {
        ...
        A09(c7s, hashMap2);
        C8N A08 = c7s.A08();
        JSONObject A05 = C02017z.A05(new AnonymousClass81(A08.A01(), A08.A02(), hashMap2));
        ...
        c0663Qv.put(A01(171, 7, 16), jSONObject2.toString());
        interfaceC0649Qh.ADq(c7s.A04().A6w(), c0663Qv.A08(), new C0749Ue(c7s));
    }
    ...
    static {
        A04();
        A02 = C0455Iq.class.getSimpleName();
    ...
    public static void A05(C7S c7s) {
        ...
        synchronized (C0455Iq.class) {
            ...
            atomicInteger.set(1);
            ExecutorC0512La.A06.execute(new C0750Uf(c7s));
        }
    }
