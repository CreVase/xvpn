...
public final class C8D {
    ...
    */
    public C8D(java.lang.String r7, java.lang.String r8, org.json.JSONObject r9, org.json.JSONArray r10) {
        /*
            r6 = this;
            r6.<init>()
        ...
        L18:
            return
        L19:
            com.facebook.ads.redexgen.X.8H[] r5 = com.facebook.ads.redexgen.X.C8H.values()
            int r4 = r5.length
            r3 = 0
        L1f:
            if (r3 >= r4) goto L30
            r2 = r5[r3]
            java.util.Map<com.facebook.ads.redexgen.X.8H, java.util.List<java.lang.String>> r1 = r6.A02
        ...
        L31:
            ...
            com.facebook.ads.redexgen.X.8H r1 = com.facebook.ads.redexgen.X.C8H.valueOf(r0)     // Catch: java.lang.Exception -> L70
            boolean r0 = android.text.TextUtils.isEmpty(r2)     // Catch: java.lang.Exception -> L70
            if (r0 != 0) goto L70
            java.util.Map<com.facebook.ads.redexgen.X.8H, java.util.List<java.lang.String>> r0 = r6.A02     // Catch: java.lang.Exception -> L70
        ...
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C8D.<init>(java.lang.String, java.lang.String, org.json.JSONObject, org.json.JSONArray):void");
    }
