...
public abstract class AbstractC0967b9 implements C0B {
    ...
    static {
        A04();
        A03 = AbstractC0967b9.class.getSimpleName();
    }
    ...
    public void AFw(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC0967b9.this.A06(this.A00);
                return null;
            }
        });
    }
