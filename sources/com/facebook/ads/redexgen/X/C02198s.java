...
public final class C02198s {
    ...
    public final synchronized C8j A06(int i, byte[] bArr, int i2, int[] iArr, int i3) throws IOException {
        ...
        if (i5 <= i) {
            return new C8j(z ? EnumC02108i.A03 : EnumC02108i.A04, i, i, 0);
        }
        A00.A02.seek(j);
        A00.A02.read(bArr, i2, i6);
        return new C8j(EnumC02108i.A02, i, i5, i6);
    }
    ...
    public C02198s(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C02188r.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 30), file.getCanonicalPath()));
        }
    }

    private C02188r A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C02188r.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i, long j) throws IOException {
        this.A00.A03[i] = j;
        this.A00.A02.seek(C02188r.A02(i));
    ...
    public final synchronized void A07() throws IOException {
        this.A01 = true;
        C02188r c02188r = this.A00;
        if (c02188r == null) {
            return;
        }
        RandomAccessFile randomAccessFile = c02188r.A02;
        this.A00 = null;
