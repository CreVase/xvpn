...
public class ViewOnTouchListenerC00421i extends ED implements View.OnTouchListener {
    ...
    public ViewOnTouchListenerC00421i(YA ya) {
        super(ya);
        this.A05 = 0;
        this.A00 = 0;
        this.A03 = true;
    ...
    public ViewOnTouchListenerC00421i(YA ya, AttributeSet attributeSet) {
    ...
    public ViewOnTouchListenerC00421i(YA ya, AttributeSet attributeSet, int i) {
    ...
    public void setLayoutManager(AbstractC01124c abstractC01124c) {
        if (abstractC01124c instanceof ZC) {
            super.setLayoutManager(abstractC01124c);
            this.A01 = (ZC) abstractC01124c;
            return;
        }
