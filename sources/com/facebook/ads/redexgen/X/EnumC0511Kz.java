...
public enum EnumC0511Kz {
    ...
    EnumC0511Kz(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0511Kz A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC0511Kz enumC0511Kz : values()) {
            if (enumC0511Kz.A01 == nativeComponentTag) {
                return enumC0511Kz;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0511Kz internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0511Kz enumC0511Kz) {
        if (view != null && enumC0511Kz != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0511Kz);
        }
    }
