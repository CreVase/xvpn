...
public final class C0964b6 implements C0G {
     ...
     */
    public final synchronized void A07() throws C0962b4 {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new C0962b4(A00(166, 20, 40) + this.A00 + A00(44, 4, 124) + file + A00(14, 16, 28));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(UserVerificationMethods.USER_VERIFY_HANDPRINT, 1, 67));
        } catch (IOException e) {
            throw new C0962b4(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e);
        }
    }

    public C0964b6(File file, C0B c0b) throws C0962b4 {
        try {
            if (c0b != null) {
                this.A02 = c0b;
                ...
                this.A01 = new RandomAccessFile(this.A00, exists ? A00(UserVerificationMethods.USER_VERIFY_HANDPRINT, 1, 67) : A00(257, 2, 119));
                return;
            }
            throw new NullPointerException();
        } catch (IOException e) {
            throw new C0962b4(A00(186, 17, 126) + file + A00(0, 14, 84), e);
        }
    }
    ...
    public final synchronized int A03() throws C0962b4 {
        try {
        } catch (IOException e) {
            throw new C0962b4(A00(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 29, 81) + this.A00, e);
        }
    ...
    public final synchronized void A05() throws C0962b4 {
        try {
            this.A01.setLength(0L);
        } catch (IOException e) {
            throw new C0962b4(A00(57, 16, 6), e);
        }
    }

    public final synchronized void A06() throws C0962b4 {
        try {
            this.A01.close();
            this.A02.AFw(this.A00);
        } catch (IOException e) {
            throw new C0962b4(A00(104, 19, 99) + this.A00, e);
        }
    }

    public final synchronized void A08(byte[] bArr, int i) throws C0962b4 {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i);
            } else {
                throw new C0962b4(A00(73, 31, 52) + this.A00 + A00(30, 14, 118));
            }
        } catch (IOException e) {
            throw new C0962b4(String.format(Locale.US, A00(203, 53, 105), Integer.valueOf(i), this.A01, Integer.valueOf(bArr.length)), e);
        }
    }
