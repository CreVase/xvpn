...
public class C00752p<K, V> {
    ...
    public int[] A01 = C00652f.A00;
    public Object[] A02 = C00652f.A02;
    public int A00 = 0;
    ...
    public final V A0A(int i) {
        ...
        if (i3 <= 1) {
            ...
            this.A01 = C00652f.A00;
            this.A02 = C00652f.A02;
            i2 = 0;
        } else {
            i2 = i3 - 1;
            int[] iArr = this.A01;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C00752p) {
            C00752p c00752p = (C00752p) obj;
            if (size() != c00752p.size()) {
                return false;
            }
            for (int i = 0; i < this.A00; i++) {
                try {
                    K A09 = A09(i);
                    V A0B = A0B(i);
                    Object obj2 = c00752p.get(A09);
                    if (A0B == null) {
                        if (obj2 == null && c00752p.containsKey(A09)) {
                        }
                        return false;
                    }
                    if (!A0B.equals(obj2)) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2p != com.facebook.ads.internal.androidx.support.v4.util.SimpleArrayMap<K, V> */
