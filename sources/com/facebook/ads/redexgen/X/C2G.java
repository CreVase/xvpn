    ...
    public static Map<String, String> A05(String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C01997x.A27, new C02007y(A02(239, 20, 101)));
                return null;
            }
            if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C01997x.A24, new C02007y(A02(221, 18, 10)));
                return null;
            }
            return hashMap;
        } catch (JSONException e) {
            A08(C01997x.A26, new C02007y(e));
            return null;
        }
    }

    private final void A07() {
        C0875Zd A5N = this.A00.A5N();
        A5N.A00(A02(518, 22, 120), 0L);
        A5N.A02();
    }

    public static void A08(int i, C02007y c02007y) {
        Y9 sdkContext = C7R.A00();
        if (sdkContext != null) {
            sdkContext.A07().A9M(A02(687, 9, 5), i, c02007y);
        }
    }
