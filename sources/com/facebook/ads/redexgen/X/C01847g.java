...
public final class C01847g {
    ...
    public C01847g(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
        options.remove(null);
        this.A00 = num;
        this.A01 = num2;
    ...
    public C01847g(String[] strArr, Integer num, Integer num2) {
    ...
    public static C01847g A00(String str) {
        if (str == null) {
            return null;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ...
        return new C01847g(linkedHashSet, num, num2, str);
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C01847g)) {
            return false;
        }
        C01847g c01847g = (C01847g) obj;
        ...
        A06[0] = "YHhc40Na8nm";
        Integer num2 = c01847g.A00;
        if (num != num2 && (num == null || !num.equals(num2))) {
            return false;
        }
        Integer num3 = this.A01;
        Integer num4 = c01847g.A01;
        return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c01847g.A03);
    }

    public final int hashCode() {
        int hashCode = this.A03.hashCode() * 131;
        Integer num = this.A00;
        int intValue = hashCode + ((num == null ? -1 : num.intValue()) * Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE);
