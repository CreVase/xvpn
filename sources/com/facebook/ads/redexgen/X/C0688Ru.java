...
public final class C0688Ru {
    ...
    public BlockingDeque<C0689Rv> A00;
    ...
    public C0688Ru(@Nullable String str) {
        this(str, 2000);
    }

    public C0688Ru(@Nullable String str, int i) {
        this.A02 = str;
        this.A01 = i;
    ...
    public static long A01(List<C0689Rv> list, int i, int i2) {
    ...
    public static String A03(String str) {
        ...
        for (int n3 = 0; n3 < sb.length(); n3 += 3) {
            ...
            int n4 = (charAt >> 12) & 63;
            StringBuilder sb4 = sb2.append(A02.charAt((charAt >> 18) & 63));
            sb4.append(A02.charAt(n4)).append(A02.charAt((charAt >> 6) & 63)).append(A02.charAt(charAt & 63));
        }
        StringBuilder r = new StringBuilder();
        String base64chars = sb2.substring(0, sb2.length() - sb3.length());
        return r.append(base64chars).append((Object) sb3).toString();
    }

    @Nullable
    public static String A04(@Nullable List<C0689Rv> list) {
        if (list == null) {
            return null;
        }
    ...
    @Nullable
    public static String A06(@Nullable List<C0689Rv> list, int i, int i2, boolean z) {
    ...
    public static void A0A(List<C0689Rv> list, int i, int i2) {
        long A00;
    ...
    public final List<C0689Rv> A0B() {
        ArrayList arrayList = new ArrayList();
        this.A00.drainTo(arrayList);
        return arrayList;
    }

    public final void A0C(C0689Rv c0689Rv) {
        C0689Rv peekLast = this.A00.peekLast();
        if (peekLast != null) {
            ...
            A04[1] = "fQhMIvl";
            if (A032 == c0689Rv.A03() && peekLast.A01() == c0689Rv.A01()) {
                return;
            }
        }
        this.A00.add(c0689Rv);
    }
}
