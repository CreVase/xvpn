...
public final class C0736Tr implements InterfaceC0513Lb {
    ...
    */
    public static void A00(int[] r42, int r43, int r44, int r45, int r46, int r47, int r48) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0736Tr.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                int h2 = h;
                int cores = i2;
                arrayList.add(new CallableC0517Lf(iArr, w, h2, (int) f, i, cores, 1));
                h = h2;
                int cores2 = i2;
                vertical.add(new CallableC0517Lf(iArr, w, h, (int) f, i, cores2, 2));
            }
            try {
                C0518Lg.A01.invokeAll(arrayList);
                try {
                    C0518Lg.A01.invokeAll(vertical);
                    try {
