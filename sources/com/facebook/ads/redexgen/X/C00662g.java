...
public final class C00662g<E> implements Cloneable {
    ...
    private final E A02(long j, E e) {
        E e2;
        int A03 = C00652f.A03(this.A02, this.A00, j);
    ...
    public final void A0B(long j, E e) {
        ...
        if (this.A01 && i2 >= this.A02.length) {
            A04();
            i = C00652f.A03(this.A02, this.A00, j) ^ (-1);
        }
        int i3 = this.A00;
        if (i3 >= this.A02.length) {
            int A00 = C00652f.A00(i3 + 1);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2g != com.facebook.ads.internal.androidx.support.v4.util.LongSparseArray<E> */
    public C00662g(int i) {
        this.A01 = false;
        if (i == 0) {
            this.A02 = C00652f.A01;
            this.A03 = C00652f.A02;
        } else {
            int A00 = C00652f.A00(i);
    ...
    public final C00662g<E> clone() {
        C00662g<E> c00662g = null;
        try {
            c00662g = (C00662g) super.clone();
            c00662g.A02 = (long[]) this.A02.clone();
            c00662g.A03 = (Object[]) this.A03.clone();
            return c00662g;
