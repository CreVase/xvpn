...
public class QT implements MediaController.MediaPlayerControl {
    ...
    public QT(TextureViewSurfaceTextureListenerC0448Ij textureViewSurfaceTextureListenerC0448Ij) {
    ...
    public final boolean isPlaying() {
        ...
        mediaPlayer = this.A00.A06;
        if (mediaPlayer != null) {
            TextureViewSurfaceTextureListenerC0448Ij textureViewSurfaceTextureListenerC0448Ij = this.A00;
            if (A01[3].length() == 27) {
                throw new RuntimeException();
            }
            A01[1] = "lkPRs4KbLtabABAzVL2ijXaoS745wM0q";
            mediaPlayer2 = textureViewSurfaceTextureListenerC0448Ij.A06;
