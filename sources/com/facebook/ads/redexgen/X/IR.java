...
public final class IR {
    ...
    public static HashMap<String, Integer> A0M(Context context) throws JSONException {
        String A2R = IP.A0Q(context).A2R(A0L(24, 35, 123), A0L(22, 2, 109));
        HashMap<String, Integer> hashMap = new HashMap<>();
        JSONArray jSONArray = new JSONArray(A2R);
    ...
    public static int A07(Context context) {
        return IP.A0Q(context).A2P(A0L(666, 36, 33), 10485760);
    }
    ...
    public static int A0A(Context context) {
        return IP.A0Q(context).A2P(A0L(405, 46, 99), 0);
    }
    ...
    public static int A0H(Context context, String str, int i) {
        int A2P = IP.A0Q(context).A2P(str, i);
        if (A2P >= 0 && A2P < 101) {
            return A2P;
        }
        return i;
    ...
    public static long A0I(Context context) {
        return IP.A0Q(context).A2Q(A0L(320, 46, 122), 2000L);
    }

    public static long A0J(Context context) {
        return IP.A0Q(context).A2P(A0L(1043, 41, 66), 300) * 1000;
    }

    public static long A0K(Context context) {
        return IP.A0Q(context).A2Q(A0L(1111, 34, 102), 500L);
    }
