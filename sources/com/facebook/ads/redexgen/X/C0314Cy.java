...
public final class C0314Cy {
    ...
    public C0314Cy(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
    ...
    public static C0314Cy A01(String str) {
        return new C0314Cy(str, null, null, true, false, false);
    }

    public static C0314Cy A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        return new C0314Cy(str, str2, codecCapabilities, false, z, z2);
    }

    private void A05(String str) {
        StringBuilder append = new StringBuilder().append(A03(38, 16, 126)).append(str);
        String A03 = A03(80, 3, 100);
        append.append(A03).append(this.A02).append(A03(4, 2, 120)).append(this.A01).append(A03).append(C0436Hx.A04).append(A03(79, 1, 119)).toString();
    }
    ...
    public static boolean A07(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0436Hx.A02 >= 19 && A08(codecCapabilities);
    }
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0436Hx.A02 >= 21 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0436Hx.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public final Point A0E(int i, int i2) {
        ...
        int heightAlignment2 = C0436Hx.A04(i, widthAlignment);
        return new Point(heightAlignment2 * widthAlignment, C0436Hx.A04(i2, heightAlignment) * heightAlignment);
    }
    ...
    public final boolean A0H(int i, int i2, double d) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(StatusLine.HTTP_MISDIRECTED_REQUEST, 16, 101));
            return false;
        }
        MediaCodecInfo.VideoCapabilities videoCapabilities = codecCapabilities.getVideoCapabilities();
        if (videoCapabilities == null) {
