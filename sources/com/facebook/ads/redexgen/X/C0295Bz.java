...
public final class C0295Bz {
    ...
    public final long A05(InterfaceC0279Bb interfaceC0279Bb, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.A01 == 0) {
            if (!interfaceC0279Bb.AEE(this.A02, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            interfaceC0279Bb.readFully(this.A02, 1, i2 - 1);
        }
        this.A01 = 0;
