...
public final class zzau extends SQLiteOpenHelper {
    private final /* synthetic */ zzao zza;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzau(zzao zzaoVar, Context context, String str) {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        zzat.zza(zzj9, sQLiteDatabase, "consent_settings", "CREATE TABLE IF NOT EXISTS consent_settings ( app_id TEXT NOT NULL, consent_state TEXT NOT NULL, PRIMARY KEY (app_id));", "app_id,consent_state", strArr9);
        if (zzpg.zza()) {
            zzfr zzj10 = this.zza.zzj();
            strArr10 = zzao.zzk;
            zzat.zza(zzj10, sQLiteDatabase, "trigger_uris", "CREATE TABLE IF NOT EXISTS trigger_uris ( app_id TEXT NOT NULL, trigger_uri TEXT NOT NULL, timestamp_millis INTEGER NOT NULL, source INTEGER NOT NULL);", "app_id,trigger_uri,source,timestamp_millis", strArr10);
        }
    }
