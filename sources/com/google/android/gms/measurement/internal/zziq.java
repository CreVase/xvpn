...
public final class zziq extends zze {
    ...
    public final void zzap() {
        ...
        if (zza != null) {
            if ("unset".equals(zza)) {
                ...
                zza("app", "_npa", Long.valueOf(j), zzb().currentTimeMillis());
            }
        }
    ...
    public final void zzan() {
        ...
        ml1 d = zzn.d(Uri.parse(poll.zza));
        if (d == null) {
            this.zzh = false;
            zzao().add(poll);
            return;
        ...
        zzk.zzi.zza(bundle);
        d.addListener(new y4(d, new zzjc(this, poll), 16), new zziz(this));
    }
    ...
    public final Map<String, Object> zza(String str, String str2, boolean z) {
        ...
        kg kgVar = new kg(list.size());
        for (zznc zzncVar : list) {
            Object zza = zzncVar.zza();
            if (zza != null) {
                kgVar.put(zzncVar.zza, zza);
            }
        }
        return kgVar;
    }

    public static /* synthetic */ void zza(zziq zziqVar, zzih zzihVar, zzih zzihVar2) {
    ...
    public static /* synthetic */ void zza(zziq zziqVar, zzih zzihVar, long j, boolean z, boolean z2) {
        zziqVar.zzt();
        zziqVar.zzu();
    ...
    public final void zza(String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        ...
        if (this.zzu.zzaf()) {
            ...
            if (zza6.getLong("extend_session", j2) == 1) {
    ...
    public final void zza(Bundle bundle, long j) {
        ...
        zzie.zza(bundle2, AppMeasurementSdk.ConditionalUserProperty.VALUE, Object.class, null);
