    ...
    public static void load(final Context context, final String str, final AdRequest adRequest, final RewardedAdLoadCallback rewardedAdLoadCallback) {
        ...
        if (((Boolean) zzbdz.zzl.zze()).booleanValue()) {
            if (((Boolean) zzba.zzc().zzb(zzbci.zzkm)).booleanValue()) {
                zzcai.zzb.execute(new Runnable() { // from class: com.google.android.gms.ads.rewarded.zzc
                    ...
                    public final void run() {
                        ...
                        try {
                            new zzbwy(context2, str2).zza(adRequest2.zza(), rewardedAdLoadCallback);
        ...
        new zzbwy(context, str).zza(adRequest.zza(), rewardedAdLoadCallback);
    }
    ...
    public static void load(final Context context, final String str, final AdManagerAdRequest adManagerAdRequest, final RewardedAdLoadCallback rewardedAdLoadCallback) {
        ...
        if (((Boolean) zzbdz.zzl.zze()).booleanValue()) {
            if (((Boolean) zzba.zzc().zzb(zzbci.zzkm)).booleanValue()) {
                ...
                zzcai.zzb.execute(new Runnable() { // from class: com.google.android.gms.ads.rewarded.zzb
                    @Override // java.lang.Runnable
                    public final void run() {
                        Context context2 = context;
                        String str2 = str;
                        ...
                        try {
                            new zzbwy(context2, str2).zza(adManagerAdRequest2.zza(), rewardedAdLoadCallback);
                        } catch (IllegalStateException e) {
        ...
        zzcat.zze("Loading on UI thread");
        new zzbwy(context, str).zza(adManagerAdRequest.zza(), rewardedAdLoadCallback);
    }
}
