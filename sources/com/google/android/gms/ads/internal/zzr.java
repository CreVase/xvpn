...
public final class zzr {
    ...
    public zzr(Context context, String str) {
        ...
        try {
            ...
            zzcat.zzh("Unable to get package version name for reporting", e);
    ...
    public final void zzf(com.google.android.gms.ads.internal.client.zzl zzlVar, zzcaz zzcazVar) {
        Bundle bundle;
        ...
        this.zzc.put("SDKVersion", zzcazVar.zza);
        if (((Boolean) zzbdp.zza.zze()).booleanValue()) {
            Bundle zzb = zzad.zzb(this.zza, (String) zzbdp.zzb.zze());
