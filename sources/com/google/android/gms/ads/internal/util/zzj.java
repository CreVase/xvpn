...
public final class zzj implements zzg {
    ...
    public final /* synthetic */ void zzS(Context context, String str) {
        ...
        synchronized (this.zza) {
            ...
            try {
                ...
                zzcat.zzk("Could not convert native advanced settings to json object", e);
            }
            zzU();
        }
    }
    ...
    public final zzbzw zzh() {
        ...
        zzT();
        synchronized (this.zza) {
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbci.zzkI)).booleanValue() && this.zzp.zzj()) {
    ...
    public final void zzr(final Context context) {
        synchronized (this.zza) {
            ...
            this.zzd = zzcbg.zza.zza(new Runnable(context, str) { // from class: com.google.android.gms.ads.internal.util.zzi
