...
public final class zzs extends zzbt {
    ...
    private final Future zzc = zzcbg.zza.zzb(new zzo(this));
    ...
    public final String zzp() {
        ...
        if (zzaroVar != null) {
            try {
                build = zzaroVar.zzb(build, this.zzd);
            } catch (zzarp e) {
                zzcat.zzk("Unable to process ad data", e);
            }
        }
        return p71.m(zzq(), "#", build.getEncodedQuery());
    }
    ...
    public final String zzq() {
        ...
        return hx2.q("https://", zzb, (String) zzbdp.zzd.zze());
    }
