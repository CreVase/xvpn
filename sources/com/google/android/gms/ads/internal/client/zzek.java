...
public final class zzek extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        try {
            ...
            zzcat.zzh("Failed to load metadata: Package name not found.", e);
        } catch (NullPointerException e2) {
            zzcat.zzh("Failed to load metadata: Null pointer exception.", e2);
        }
        zzboq zza = zzboq.zza();
        if (bundle == null) {
            zzcat.zzg("Metadata was null.");
        } else {
            try {
                    ...
                    try {
                        ...
                        if (str != null) {
                            if (str.matches("^ca-app-pub-[0-9]{16}~[0-9]{10}$")) {
                                zzcat.zze("Publisher provided Google AdMob App ID in manifest: ".concat(str));
                            ...
                            zzcat.zze("The Google Mobile Ads SDK is integrated by ".concat(String.valueOf(str2)));
                        } else {
        ...
        if (bundle != null) {
            ...
            if (z) {
                zzcat.zze("com.google.android.gms.ads.flag.OPTIMIZE_INITIALIZATION is enabled");
            }
            if (z2) {
                zzcat.zze("com.google.android.gms.ads.flag.OPTIMIZE_AD_LOADING is enabled");
            }
        }
