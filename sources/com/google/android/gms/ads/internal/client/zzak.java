...
public final class zzak extends zzax {
    ...
    public zzak(zzaw zzawVar, Context context, zzq zzqVar, String str, zzbox zzboxVar) {
        this.zze = zzawVar;
        this.zza = context;
        this.zzb = zzqVar;
        this.zzc = str;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzce zzceVar) throws RemoteException {
        return zzceVar.zzc(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 233702000);
    }
