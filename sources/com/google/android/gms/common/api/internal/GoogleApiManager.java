...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new ng(0);
    private final Set zaq = new ng(0);
        ...
        switch (message.what) {
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    ...
                    Log.wtf("GoogleApiManager", p71.k("Could not find API instance ", i, " while trying to fail enqueued calls."), new Exception());
                }
                return true;
            case 6:
