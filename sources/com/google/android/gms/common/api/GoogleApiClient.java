    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                kgVar.put(api2, Boolean.valueOf(z2));
                ...
                kgVar2.put(api2.zab(), buildClient);
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        throw new IllegalStateException(p71.m(api2.zad(), " cannot be used with ", api.zad()));
                    }
                }
            }
            if (api != null) {
                if (!z3) {
                    ...
                    throw new IllegalStateException(hx2.q("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, kgVar, this.zaq, this.zar, kgVar2, this.zal, zabe.zad(kgVar2.values(), true), arrayList);
        ...
        public Builder enableAutoManage(l lVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) lVar);
        ...
        public Builder enableAutoManage(l lVar, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(lVar, 0, onConnectionFailedListener);
            return this;
        }
