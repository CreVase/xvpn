...
public interface zzlc {
    ...
    <T> void zza(T t, zzlb<T> zzlbVar, zzik zzikVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzlb<T> zzlbVar, zzik zzikVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzke<K, V> zzkeVar, zzik zzikVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzlb<T> zzlbVar, zzik zzikVar) throws IOException;

    void zzb(List<zzhm> list) throws IOException;

    <T> void zzb(List<T> list, zzlb<T> zzlbVar, zzik zzikVar) throws IOException;
