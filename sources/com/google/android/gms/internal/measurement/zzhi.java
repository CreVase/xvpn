...
public final class zzhi {
    ...
    public static int zzd(byte[] bArr, int i, zzhl zzhlVar) {
        int i2 = i + 1;
        long j = bArr[i];
        if (j >= 0) {
            zzhlVar.zzb = j;
    ...
    public static int zza(byte[] bArr, int i, zzhl zzhlVar) throws zzji {
    ...
    public static int zzb(byte[] bArr, int i, zzhl zzhlVar) throws zzji {
        int zzc = zzc(bArr, i, zzhlVar);
        int i2 = zzhlVar.zza;
        if (i2 < 0) {
            throw zzji.zzf();
    ...
    public static int zzc(byte[] bArr, int i, zzhl zzhlVar) {
        int i2 = i + 1;
        byte b2 = bArr[i];
        if (b2 >= 0) {
            zzhlVar.zza = b2;
    ...
    public static int zza(zzlb zzlbVar, byte[] bArr, int i, int i2, int i3, zzhl zzhlVar) throws IOException {
    ...
    public static int zza(zzlb zzlbVar, byte[] bArr, int i, int i2, zzhl zzhlVar) throws IOException {
        Object zza = zzlbVar.zza();
    ...
    public static int zza(zzlb<?> zzlbVar, int i, byte[] bArr, int i2, int i3, zzjf<?> zzjfVar, zzhl zzhlVar) throws IOException {
    ...
    public static int zza(byte[] bArr, int i, zzjf<?> zzjfVar, zzhl zzhlVar) throws IOException {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzlz zzlzVar, zzhl zzhlVar) throws zzji {
        if ((i >>> 3) == 0) {
            throw zzji.zzc();
        }
        int i4 = i & 7;
    ...
    public static int zza(int i, byte[] bArr, int i2, zzhl zzhlVar) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b2 = bArr[i2];
        if (b2 >= 0) {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzjf<?> zzjfVar, zzhl zzhlVar) {
        zzja zzjaVar = (zzja) zzjfVar;
        int zzc = zzc(bArr, i2, zzhlVar);
        zzjaVar.zzd(zzhlVar.zza);
        while (zzc < i3) {
    ...
    public static int zza(Object obj, zzlb zzlbVar, byte[] bArr, int i, int i2, int i3, zzhl zzhlVar) throws IOException {
        int zza = ((zzkn) zzlbVar).zza((zzkn) obj, bArr, i, i2, i3, zzhlVar);
        zzhlVar.zzc = obj;
        return zza;
    }

    public static int zza(Object obj, zzlb zzlbVar, byte[] bArr, int i, int i2, zzhl zzhlVar) throws IOException {
        int i3 = i + 1;
        int i4 = bArr[i];
        if (i4 < 0) {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzhl zzhlVar) throws zzji {
        if ((i >>> 3) == 0) {
            throw zzji.zzc();
        }
        int i4 = i & 7;
