...
interface zzmw {
    ...
    void zza(int i, zzhm zzhmVar) throws IOException;

    <K, V> void zza(int i, zzke<K, V> zzkeVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzlb zzlbVar) throws IOException;
    ...
    @Deprecated
    void zza(int i, List<?> list, zzlb zzlbVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzlb zzlbVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzlb zzlbVar) throws IOException;
