...
public final class zzng implements zznh {
    ...
    static {
        ...
        zzk = zza2.zza("measurement.upload.max_event_parameter_value_length", 100L);
        zzl = zza2.zza("measurement.store.max_stored_events_per_app", 100000L);
        zzm = zza2.zza("measurement.experiment.max_ids", 50L);
        zzn = zza2.zza("measurement.audience.filter_result_max_count", 200L);
        zzo = zza2.zza("measurement.upload.max_item_scoped_custom_parameters", 27L);
        zzp = zza2.zza("measurement.rb.attribution.client.min_ad_services_version", 7L);
        zzq = zza2.zza("measurement.alarm_manager.minimum_interval", 60000L);
        zzr = zza2.zza("measurement.upload.minimum_delay", 500L);
        zzs = zza2.zza("measurement.monitoring.sample_period_millis", 86400000L);
        zzt = zza2.zza("measurement.rb.attribution.app_allowlist", "");
        zzu = zza2.zza("measurement.upload.realtime_upload_interval", 10000L);
        zzv = zza2.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        zzw = zza2.zza("measurement.config.cache_time.service", 3600000L);
        ...
        zzai = zza2.zza("measurement.upload.interval", 3600000L);
        ...
        zzao = zza2.zza("measurement.upload.max_events_per_day", 100000L);
        ...
        zzau = zza2.zza("measurement.upload.retry_time", 1800000L);
        zzav = zza2.zza("measurement.upload.url", "https://app-measurement.com/a");
        zzaw = zza2.zza("measurement.upload.window_interval", 3600000L);
