...
public class zzlg<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        ...
        if (zza((zzlg<K, V>) comparable) < 0 && !this.zzc.containsKey(comparable)) {
            return false;
        }
        return true;
    }
    ...
    public static <FieldDescriptorType extends zzis<FieldDescriptorType>> zzlg<FieldDescriptorType, Object> zza(int i) {
        return new zzlf(i);
    }
