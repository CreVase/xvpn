...
public final class zzggv {
    ...
    public zzggv(byte[] bArr, boolean z) throws GeneralSecurityException {
        if (zzghf.zza(2)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x002a, code lost:            if (r2.equals("The Android Project") != false) goto L14;     */
    /*
    ...
    */
    public final byte[] zza(byte[] r7, byte[] r8, byte[] r9) throws java.security.GeneralSecurityException {
        ...
        L42:
            ...
            r2.<init>(r4, r7, r3, r1)
        L49:
            java.lang.ThreadLocal r7 = com.google.android.gms.internal.ads.zzggv.zza
        ...
        L82:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzggv.zza(byte[], byte[], byte[]):byte[]");
    }
}
