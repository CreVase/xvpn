...
interface zzgvu {
    ...
    @Deprecated
    void zzC(List list, zzgwc zzgwcVar, zzgtl zzgtlVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgwc zzgwcVar, zzgtl zzgtlVar) throws IOException;
    ...
    zzgsr zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgwc zzgwcVar, zzgtl zzgtlVar) throws IOException;

    void zzu(Object obj, zzgwc zzgwcVar, zzgtl zzgtlVar) throws IOException;
