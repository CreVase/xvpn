...
final class zzagl {
    ...
    public final long zzd(zzabn zzabnVar, boolean z, boolean z2, int i) throws IOException {
        if (this.zzc == 0) {
            if (!zzabnVar.zzn(this.zzb, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            ((zzabc) zzabnVar).zzn(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
