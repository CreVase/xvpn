...
public final class zzcad {
    ...
    public final void zzg(com.google.android.gms.ads.internal.client.zzl zzlVar, long j) {
        ...
        synchronized (this.zzj) {
            ...
            if (this.zzb == -1) {
                if (currentTimeMillis - zzd > ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbci.zzaS)).longValue()) {
                    this.zzd = -1;
                } else {
            ...
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbci.zzdq)).booleanValue() && (bundle = zzlVar.zzc) != null && bundle.getInt("gw", 2) == 1) {
                return;
            }
            this.zzc++;
            int i = this.zzd + 1;
