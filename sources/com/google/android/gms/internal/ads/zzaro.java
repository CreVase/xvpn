...
public final class zzaro {
    ...
    private final Uri zzg(Uri uri, String str) throws zzarp {
        uri.getClass();
        try {
            try {
                if (uri.getHost().equals(this.zzb)) {
                    if (uri.getPath().contains(";")) {
                        ...
                        throw new zzarp("Parameter already exists: dc_ms");
                    }
                }
            } catch (UnsupportedOperationException unused) {
                throw new zzarp("Provided Uri is not in a valid state");
            }
        ...
        throw new zzarp("Query parameter already exists: ms");
    }

    @Deprecated
    public final Uri zza(Uri uri, Context context, View view, Activity activity) throws zzarp {
        try {
    ...
    @Deprecated
    public final Uri zzb(Uri uri, Context context) throws zzarp {
        return zzg(uri, this.zzd.zzg(context));
    }

    @Deprecated
    public final zzark zzc() {
        return this.zzd;
    }
