...
public final class zzbmc extends AdManagerInterstitialAd {
    ...
    public zzbmc(Context context, String str) {
        ...
        this.zzc = com.google.android.gms.ads.internal.client.zzay.zza().zze(context, new com.google.android.gms.ads.internal.client.zzq(), str, zzbouVar);
    }
        ...
        try {
            ...
            if (zzbuVar != null) {
                if (appEventListener != null) {
                    zzavkVar = new zzavk(appEventListener);
                } else {
                    zzavkVar = null;
                }
                zzbuVar.zzG(zzavkVar);
            }
        } catch (RemoteException e) {
            zzcat.zzl("#007 Could not call remote method.", e);
        }
