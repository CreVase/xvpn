...
public final class zzbve extends AbstractSafeParcelable {
    ...
    public zzbve(@SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        ...
        if (this.zza == null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        zzcbg.zza.execute(new Runnable() { // from class: com.google.android.gms.internal.ads.zzbvd
                                ...
                                try {
                                    try {
                                        ...
                                        try {
                                            ...
                                            zzcat.zzh("Error transporting the ad response", e);
    ...
    public final SafeParcelable zza(Parcelable.Creator creator) {
        if (this.zzc) {
            if (this.zza == null) {
                zzcat.zzg("File descriptor is empty, returning null.");
                return null;
            }
            ...
            try {
                try {
                    ...
                    zzcat.zzh("Could not read from parcel file descriptor", e);
                    IOUtils.closeQuietly(dataInputStream);
                    return null;
                }
            } catch (Throwable th2) {
