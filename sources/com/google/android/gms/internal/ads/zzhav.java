...
public final class zzhav {
    public static final zzhav zza = new zzhav(1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhav zzb = new zzhav(0.0d, 1.0d, -1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhav zzc = new zzhav(-1.0d, 0.0d, 0.0d, -1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhav zzd = new zzhav(0.0d, -1.0d, 1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    ...
    public zzhav(double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        this.zze = d5;
        this.zzf = d6;
        this.zzg = d7;
        this.zzh = d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (Double.compare(zzhavVar.zzh, this.zzh) == 0 && Double.compare(zzhavVar.zzi, this.zzi) == 0 && Double.compare(zzhavVar.zzj, this.zzj) == 0 && Double.compare(zzhavVar.zzk, this.zzk) == 0 && Double.compare(zzhavVar.zzl, this.zzl) == 0 && Double.compare(zzhavVar.zzm, this.zzm) == 0 && Double.compare(zzhavVar.zze, this.zze) == 0 && Double.compare(zzhavVar.zzf, this.zzf) == 0 && Double.compare(zzhavVar.zzg, this.zzg) == 0) {
            return true;
        }
        return false;
    }
