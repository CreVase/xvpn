...
public final class zzabc implements zzabn {
    ...
    public zzabc(zzt zztVar, long j, long j2) {
        this.zzb = zztVar;
        this.zzd = j;
        this.zzc = j2;
    }
    ...
    public final int zzc(int i) throws IOException {
        int zzr = zzr(1);
        if (zzr == 0) {
            zzr = zzq(this.zza, 0, Math.min(1, v.DEFAULT_BUFFER_SIZE), 0, true);
        }
        zzs(zzr);
        return zzr;
    }
    ...
    public final boolean zzo(int i, boolean z) throws IOException {
        int zzr = zzr(i);
        while (zzr < i && zzr != -1) {
            zzr = zzq(this.zza, -zzr, Math.min(i, zzr + v.DEFAULT_BUFFER_SIZE), zzr, false);
        }
        zzs(zzr);
        if (zzr != -1) {
            return true;
