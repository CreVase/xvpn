...
public final class zzed implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzed(Handler handler, zzec zzecVar) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzef {
        ...
        zzeg.zzb(z, "eglGetDisplay failed");
        int[] iArr3 = new int[2];
        zzeg.zzb(EGL14.eglInitialize(eglGetDisplay, iArr3, 0, iArr3, 1), "eglInitialize failed");
        ...
        zzeg.zzb(z2, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr4[0]), eGLConfigArr[0]));
        ...
        zzeg.zzb(z3, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzeg.zzb(z4, "eglCreatePbufferSurface failed");
        }
        zzeg.zzb(EGL14.eglMakeCurrent(eGLDisplay2, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
