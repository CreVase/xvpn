...
public final class zzfak implements zzhbc {
    private final zzhbp zza;
    private final zzhbp zzb;
    private final zzhbp zzc;

    public zzfak(zzhbp zzhbpVar, zzhbp zzhbpVar2, zzhbp zzhbpVar3) {
        this.zza = zzhbpVar;
        this.zzb = zzhbpVar2;
        this.zzc = zzhbpVar3;
    }
    ...
    public final zzfai zzb() {
        ...
        if (((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbci.zzgD)).intValue() > 0) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbci.zzgm)).booleanValue() || z) {
                zzffn zza = zzffoVar.zza(zzffe.AppOpen, context, zzfewVar, new zzezm(new zzezj()));
