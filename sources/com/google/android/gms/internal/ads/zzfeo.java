...
public final class zzfeo {
    public static com.google.android.gms.ads.internal.client.zze zza(Throwable th) {
        if (th instanceof zzeey) {
            zzeey zzeeyVar = (zzeey) th;
            return zzc(zzeeyVar.zza(), zzeeyVar.zzb());
        }
        if (th instanceof zzdwm) {
            if (th.getMessage() == null) {
                return zzd(((zzdwm) th).zza(), null, null);
            }
            return zzd(((zzdwm) th).zza(), th.getMessage(), null);
        }
        if (th instanceof com.google.android.gms.ads.internal.util.zzba) {
            ...
            return new com.google.android.gms.ads.internal.client.zze(zzbaVar.zza(), zzftl.zzc(zzbaVar.getMessage()), MobileAds.ERROR_DOMAIN, null, null);
        }
        return zzd(1, null, null);
    }

    public static com.google.android.gms.ads.internal.client.zze zzb(Throwable th, zzeez zzeezVar) {
            ...
            if (i != 0) {
                ...
                switch (i2) {
                    ...
                    default:
                        ...
                        break;
                    case 12:
                        if (((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbci.zzid)).intValue() <= 0) {
