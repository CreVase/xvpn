...
public abstract class zzbhk extends zzaun implements zzbhl {
    public zzbhk() {
        ...
        switch (i) {
            ...
            case 21:
                ...
                if (readStrongBinder == null) {
                    ...
                    if (queryLocalInterface instanceof zzbhi) {
                        zzbhgVar = (zzbhi) queryLocalInterface;
                    } else {
                        zzbhgVar = new zzbhg(readStrongBinder);
                    }
                }
                zzauo.zzc(parcel);
                zzF(zzbhgVar);
