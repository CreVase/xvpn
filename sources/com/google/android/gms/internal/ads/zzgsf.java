...
final class zzgsf extends zzgsb implements RandomAccess, zzgvq {
    private static final zzgsf zza = new zzgsf(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzguj.zzd;
        collection.getClass();
        if (!(collection instanceof zzgsf)) {
            return super.addAll(collection);
        }
        zzgsf zzgsfVar = (zzgsf) collection;
        int i = zzgsfVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgsfVar.zzb, 0, this.zzb, this.zzc, zzgsfVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgsf zzgsfVar = (zzgsf) obj;
        if (this.zzc != zzgsfVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgsfVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgui zzd(int i) {
        if (i >= this.zzc) {
            return new zzgsf(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzgsf(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
