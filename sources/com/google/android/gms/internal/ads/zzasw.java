...
public final class zzasw implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzasw(Context context, zzasi zzasiVar) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x007f, code lost:            if ((r8.flags & 524288) != 0) goto L50;     */
    /* JADX WARN: Code restructure failed: missing block: B:47:0x0069, code lost:            r6 = null;     */
    /*
    ...
    */
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzasv zzasvVar = new zzasv(this);
            this.zzf = zzasvVar;
            this.zzb.registerReceiver(zzasvVar, intentFilter);
        }
