...
public final class zzfud extends zzfug implements NavigableSet {
    final /* synthetic */ zzful zzb;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzfud(zzful zzfulVar, NavigableMap navigableMap) {
    ...
    @Override // com.google.android.gms.internal.ads.zzfug, java.util.SortedSet, java.util.NavigableSet
    ...
    public final NavigableSet headSet(Object obj, boolean z) {
        return new zzfud(this.zzb, ((NavigableMap) ((SortedMap) this.zzd)).headMap(obj, z));
    }

    @Override // java.util.NavigableSet
    public final NavigableSet subSet(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfud(this.zzb, ((NavigableMap) ((SortedMap) this.zzd)).subMap(obj, z, obj2, z2));
    }

    @Override // java.util.NavigableSet
    public final NavigableSet tailSet(Object obj, boolean z) {
        return new zzfud(this.zzb, ((NavigableMap) ((SortedMap) this.zzd)).tailMap(obj, z));
    }
}
