...
final class zzgts extends zzgsb implements RandomAccess, zzgvq {
    private static final zzgts zza = new zzgts(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzguj.zzd;
        collection.getClass();
        if (!(collection instanceof zzgts)) {
            return super.addAll(collection);
        }
        zzgts zzgtsVar = (zzgts) collection;
        int i = zzgtsVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgtsVar.zzb, 0, this.zzb, this.zzc, zzgtsVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof zzgts)) {
            return super.equals(obj);
        }
        zzgts zzgtsVar = (zzgts) obj;
        if (this.zzc != zzgtsVar.zzc) {
            return false;
        }
        float[] fArr = zzgtsVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgui zzd(int i) {
        if (i >= this.zzc) {
            return new zzgts(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzgts(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
