...
final class zzbpr implements MediationAdLoadCallback {
    ...
    public final void onFailure(AdError adError) {
        try {
            zzcat.zze(this.zzb.getClass().getCanonicalName() + "failed to load mediation ad: ErrorCode = " + adError.getCode() + ". ErrorMessage = " + adError.getMessage() + ". ErrorDomain = " + adError.getDomain());
