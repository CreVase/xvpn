...
public final class zzbv {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && zzbv.class == obj.getClass()) {
            ...
            if (zzfk.zzE(this.zzc, zzbvVar.zzc) && zzfk.zzE(this.zzd, zzbvVar.zzd) && zzfk.zzE(this.zze, zzbvVar.zze) && zzfk.zzE(this.zzf, zzbvVar.zzf) && zzfk.zzE(null, null) && zzfk.zzE(null, null) && zzfk.zzE(this.zzg, zzbvVar.zzg) && zzfk.zzE(null, null) && zzfk.zzE(null, null) && Arrays.equals(this.zzh, zzbvVar.zzh) && zzfk.zzE(this.zzi, zzbvVar.zzi) && zzfk.zzE(null, null) && zzfk.zzE(this.zzj, zzbvVar.zzj) && zzfk.zzE(this.zzk, zzbvVar.zzk) && zzfk.zzE(this.zzl, zzbvVar.zzl) && zzfk.zzE(this.zzm, zzbvVar.zzm) && zzfk.zzE(null, null) && zzfk.zzE(this.zzo, zzbvVar.zzo) && zzfk.zzE(this.zzp, zzbvVar.zzp) && zzfk.zzE(this.zzq, zzbvVar.zzq) && zzfk.zzE(this.zzr, zzbvVar.zzr) && zzfk.zzE(this.zzs, zzbvVar.zzs) && zzfk.zzE(this.zzt, zzbvVar.zzt) && zzfk.zzE(this.zzu, zzbvVar.zzu) && zzfk.zzE(this.zzv, zzbvVar.zzv) && zzfk.zzE(this.zzw, zzbvVar.zzw) && zzfk.zzE(null, null) && zzfk.zzE(null, null) && zzfk.zzE(this.zzx, zzbvVar.zzx) && zzfk.zzE(null, null) && zzfk.zzE(this.zzy, zzbvVar.zzy) && zzfk.zzE(this.zzz, zzbvVar.zzz)) {
                return true;
            }
        }
        return false;
