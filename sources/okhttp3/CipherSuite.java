...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (i23.q1(str, "TLS_", false)) {
                return m20.d1(str.substring(4), "SSL_");
            }
            if (i23.q1(str, "SSL_", false)) {
                return m20.d1(str.substring(4), "TLS_");
            }
            return str;
        }
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < min; i++) {
                    ...
                    if (charAt != charAt2) {
                        return m20.W(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public /* synthetic */ CipherSuite(String str, ng0 ng0Var) {
        this(str);
    }
