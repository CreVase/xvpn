...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> cls) {
            ...
            while (cls2 != null && !m20.L(cls2.getSimpleName(), "OpenSSLSocketImpl")) {
                cls2 = cls2.getSuperclass();
                if (cls2 == null) {
                    throw new AssertionError(m20.d1(cls, "No OpenSSLSocketImpl superclass of socket of type "));
                }
            }
        ...
        public final DeferredSocketAdapter.Factory factory(final String str) {
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(SSLSocket sSLSocket) {
                    return i23.q1(sSLSocket.getClass().getName(), m20.d1(".", str), false);
                }
            };
        }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        ...
        try {
            ...
            return new String(bArr, dx.f1853a);
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InvocationTargetException e2) {
            Throwable cause = e2.getCause();
            if ((cause instanceof NullPointerException) && m20.L(((NullPointerException) cause).getMessage(), "ssl == null")) {
                return null;
            }
            throw new AssertionError(e2);
        }
